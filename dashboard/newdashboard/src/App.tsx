...
export default function App() {
  ...
  const getTabTitle = (tab: TabId) => {
    switch (tab) {
      ...
      case 'dispositivos': return { title: 'Ambientes', sub: 'Controle manual de aparelhos, luzes e sensores.' };
      ...
      case 'biblioteca': return { title: 'Biblioteca', sub: 'Livros e leitura interativa' };
