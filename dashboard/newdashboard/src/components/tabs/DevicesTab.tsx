    ...
    <div className="flex flex-col gap-6 h-full pb-10 overflow-y-auto custom-scrollbar pr-2">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <div className="glass-panel p-5 opacity-50 border-dashed border-white/10 select-none grayscale hover:grayscale-0 transition-all duration-500 cursor-not-allowed flex flex-col items-center justify-center text-center gap-3">
