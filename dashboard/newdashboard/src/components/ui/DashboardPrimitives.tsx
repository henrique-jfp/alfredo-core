...
/** Skeleton for a MetricCard (KPI) */
export function SkeletonMetricCard() {
  return (
    <div className="alfredo-card flex flex-col gap-3 p-5">
...
/** Skeleton for a conversation/activity item */
...
/** Skeleton grid: a row of MetricCard skeletons */
...
/** Skeleton for the conversations section */
export function SkeletonConversations({ count = 3 }: { count?: number }) {
  return (
