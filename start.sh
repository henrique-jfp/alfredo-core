...
screen -S satellite -dm bash -c 'cd ~/alfredo-core && export XDG_RUNTIME_DIR=/run/user/1000 && export PULSE_SERVER=unix:/run/user/1000/pulse/native && source .venv/bin/activate && python3 -u scripts/local_satellite.py | tee satellite.log'
